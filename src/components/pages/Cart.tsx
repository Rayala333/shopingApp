...
const Cart = () => {
  ...
  // </section>
      <div className='container'>
            <Link to='/' style={{marginTop:"50px"}}><FaArrowAltCircleRight style={{fontSize:"2rem",color:"#645bc8",margin:"10px"}} />click hear to shopping</Link>
            <p>cart development in progress</p>
      </div>
  )
}
